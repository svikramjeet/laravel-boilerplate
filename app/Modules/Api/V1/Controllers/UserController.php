...
class UserController extends ApiController
{
    ...
    private function saveUser($input)
    {
        ...
        if ($user_info->getErrors()) {
            $response_data = $this->createJsonResponse($user_info->getErrors(),
    ...
    private function checkRegistrationStep($id, $role_id)
    {
        ...
        if (($role_id == Config::get('constants.USER_ROLE.EMPLOYER')
        ...
        if (($role_id == Config::get('constants.USER_ROLE.PROFESSIONAL')
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($registration_step == Config::get('constants.REGISTRATION_STEP.EXPERIENCE')
    ...
    public function details($id)
    {
        ...
        if ($validator->fails()) {
            ...
            ], __('messages.error.not_found'), 404);
        }
